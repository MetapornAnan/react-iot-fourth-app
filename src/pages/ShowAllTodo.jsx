...
export default function ShowAllTodo() {
  ...
  useEffect(()=>{
    //ฟังก์ชันดึงมาจาก Table ใน Postgres บน Supabase
  ...
  const handleDeleteClick = async (id) => {
    if( confirm('คุณต้องการลบข้อมูลหรือไม่ ?')){
      //ลบข้อมูลออกจาก Table ใน Progres บน Supabase
    ...
    <div>
      ...
      <img src={todo} alt="todo" className="w-50 mx-auto" />
        ...
        <div className='mt-5 flex justify-end'>
          <Link to={'/addtodo'} className='bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded'>
          เพิ่มงานใหม่
          </Link>
        </div>

        {/* ตารางแสดงข้อมูลที่ดึงมาจาก Supabase */}
