...
export default function AddTodo() {
  ...
  //ฟังก์ชันสำหรับการบันทึกข้อมูลไปยัง Table ใน Postgres บน Supabase
  const handleSaveClick = async () => {
    //บันทึกข้อมูลลง Table ใน Postgres บน Supabase
    ...
    //แสดงข้อความแจ้งผล และredirect กลับไปที่หน้าจอ /showalltodo
